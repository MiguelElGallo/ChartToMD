...
# Origin of code snippet: Azure-Samples/azure-search-openai-demo
...
class ContentUnderstandingDescriber:
    ...
    async def create_analyzer(self):
        logger.info("Creating analyzer '%s'...",
                    self.analyzer_schema["analyzerId"])
        ...
        async with aiohttp.ClientSession() as session:
            ...
            with Progress() as progress:
                progress.add_task("Creating analyzer...",
